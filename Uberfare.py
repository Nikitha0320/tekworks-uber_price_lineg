...
distance=st.number_input("Distance (km)",min_value=0.5,max_value=50.0,value=0.50)
passengers=st.number_input("Number of Passengers", min_value=1.0, max_value=10.0, value=1.0)
